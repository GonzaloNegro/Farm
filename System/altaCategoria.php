...
<script>
    ...
    function validar_formulario(form){
        if (form.cat.value == "") { 
            alerta('\"Nombre de categoria\"'); form.cat.focus(); return true; 
            }else{
                $(document).ready(function() {
                    $('#btnform').click(function() {
                        Swal.fire({
                                title: "¿Está seguro que desea dar de alta la categoria?",
                                type: "warning",
...
<div class="centrado">
    ...
    <div class="centrado--form">
        <form action="./agrCategoria.php" name="form_mod" id="form_mod" method="POST" class="centrado--form--form">
            <div>
                <label for="name">Nombre de Categoria:</label>
                <input type="text" name="cat" id="prov" required>
            </div>
