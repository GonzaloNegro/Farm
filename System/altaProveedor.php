...
<script>
    ...
    function validar_formulario(form){
        if (form.prov.value == "") { 
            alerta('\"Nombre del proveedor\"'); form.prov.focus(); return true; 
            }else{
                $(document).ready(function() {
                    $('#btnform').click(function() {
                        Swal.fire({
                                title: "¿Está seguro que desea dar de alta al proveedor?",
                                type: "warning",
...
<div class="centrado">
    ...
    <div class="centrado--form">
        <form action="./agrProveedor.php" name="form_mod" id="form_mod" method="POST" class="centrado--form--form">
            <div>
