...
<script type="text/javascript">
    function error(){
        swal.fire(  {title: "El proveedor ya se encuentra registrado!",
                icon: "error",
                showConfirmButton: true,
                showCancelButton: false,
                });
